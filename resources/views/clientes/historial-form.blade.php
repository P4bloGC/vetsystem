<div class="row">
	<form id="historialForm" method="post" action="{{route('agregarHistorialClinico')}}" onsubmit="agregarHistorialClinico({{ $id_mascotas }}); return false;">
		<input type="hidden" name="_token" value="{{ csrf_token() }}">
		<input type="hidden" name="id_mascotas" value="{{ $id_mascotas }}">
		<div class="col-md-6">
			<label for="temperatura">Temperatura</label>
			<div class="input-group">
				<input type="number" class="form-control" id="temperatura" name="temperatura" step="any" required>
		...
		<div class="col-md-12">
			...
			<textarea class="form-control" id="comentarios-historial" name="comentarios">EDAD: {{$edad}}.</textarea>
		</div>
